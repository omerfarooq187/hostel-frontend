...
export default function VerifyEmail() {
  ...
  if (loading) {
    return (
      <>
        <Navbar />
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-50 to-gray-100 p-4 pt-24">
                ...
                <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm text-orange-700">Account pending admin approval</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <button
                      ...
                      disabled={resending}
                      className="w-full flex items-center justify-center gap-2 px-6 py-3 bg-orange-600 hover:bg-orange-700 text-white rounded-lg font-medium transition-colors disabled:opacity-50"
                    >
                      {resending ? (
                        <>
                    ...
                    <Link
                      to="/register"
                      className="w-full flex items-center justify-center gap-2 px-6 py-3 border-2 border-orange-600 hover:bg-orange-600 hover:text-white text-orange-600 rounded-lg font-medium transition-colors"
                    >
                      <ArrowRightIcon className="h-5 w-5" />
                      Register Again
                    </Link>
